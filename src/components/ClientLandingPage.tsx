      ...
      <header className="sticky top-0 z-40 backdrop-blur-lg bg-stone-950/90 border-b border-stone-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
          ...
          <a href="#" className="flex items-center gap-3 group">
            <div className="h-11 w-11 rounded-2xl bg-gradient-to-br from-emerald-800 to-stone-900 border border-emerald-500/40 flex items-center justify-center text-emerald-300 shadow-lg shadow-emerald-950/60 group-hover:border-emerald-400 transition-all">
            ...
            <div>
              ...
              <div className="text-[11px] text-emerald-400 tracking-wide flex items-center gap-1">
                <span>Сибирский травник • Горный Алтай</span>
              </div>
            </div>
          </a>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-stone-300 text-sm sm:text-base lg:text-lg leading-relaxed max-w-2xl font-normal">
                Пошаговый физиологический запуск оттока желчи на алтайских дикоросах от сибирского травника Ждана Таёжного. Без голодовок, без аптечной химии и жестких диет.
              </p>
              ...
              <div className="pt-2">
                <div className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-stone-900/90 border border-stone-800 text-stone-300 text-xs">
                  ...
                  <span>В дополнительных материалах: <span className="text-emerald-300 font-semibold">подкаст-разбор методики Ждана</span></span>
                </div>
              </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            ...
            <p className="text-xs sm:text-sm text-stone-400">
              Синтетические ферменты и слабительные лишь заглушают сигнал тревоги, делая кишечник «ленивым». Метод Ждана работает с первопричиной — физиологией оттока желчи:
            </p>
          </div>
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="border-b border-stone-800 bg-stone-950/80 text-stone-300 font-bold">
                  ...
                  <th className="p-4 sm:p-5 text-emerald-400 bg-emerald-950/40">Протокол Ждана Таёжного</th>
                </tr>
              </thead>
            ...
            <div className="flex flex-wrap items-baseline justify-between gap-4 pb-6 border-b border-stone-800">
              <div>
                ...
                <p className="text-xs text-stone-300 mt-1">
                  14-дневный протокол «Таёжный Перезапуск» + Веб-трекер + Рецептурник Ждана + Подкаст-разбор методики
                </p>
              </div>
              ...
              <div className="p-8 rounded-2xl bg-emerald-950/90 border border-emerald-500 space-y-5 text-center">
                ...
                <div className="pt-3 flex flex-col sm:flex-row items-center justify-center gap-3">
                  ...
                  >
                    ...
                    <span>Войти в закрытый Telegram-канал</span>
                  </a>
                  <button
                    type="button"
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-6 border-b border-stone-800">
            <div className="space-y-1">
              <div className="flex items-center gap-2 text-stone-200">
                ...
                <span className="font-['Cinzel'] font-bold text-stone-100">ЖДАН ТАЁЖНЫЙ</span>
                <span>• Оздоровительный протокол «Таёжный Перезапуск»</span>
              </div>
