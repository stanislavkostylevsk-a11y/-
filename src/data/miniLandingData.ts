...
export const MINI_PROGRAM_PHASES: MiniProgramPhase[] = [
  {
    ...
    steps: [
      ...
      "Диафрагмальная гимнастика Ждана (3 минуты для снятия спазма сфинктера Одди)",
...
export const MINI_PACKAGE_ITEMS = [
  ...
  {
    title: "Бонусный подкаст: Разбор методики Ждана",
...
<head>
  ...
  <title>Таёжный Перезапуск за 14 дней — Ждан Таёжный (63 года)</title>
  ...
  <header class="border-b border-stone-800/80 bg-stone-950/90 backdrop-blur-md sticky top-8 z-40">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
      <div class="flex items-center gap-2">
        ...
        <div>
          <p class="font-cinzel font-bold text-sm tracking-wider text-emerald-400">ЖДАН ТАЁЖНЫЙ</p>
          <p class="text-[10px] text-stone-400">Сибирский натуропат (63 года)</p>
        </div>
      </div>
  ...
  <main class="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-16">
    ...
    <section class="space-y-6 pt-4 text-center sm:text-left">
      ...
      <p class="text-base sm:text-lg text-stone-300 leading-relaxed max-w-2xl">
        Практический сибирский протокол Ждана Таёжного (63 года) на дикоросах и физиологическом запуске оттока желчи вместе с интерактивным веб-трекером привычек.
      </p>
      ...
      <div class="p-4 rounded-2xl border border-stone-800 bg-stone-900/70 flex flex-col sm:flex-row items-center gap-4 text-left">
        ...
        />
        <div class="space-y-1">
          <p class="font-bold text-stone-100 text-sm">Автор метода: Ждан Таёжный (63 года)</p>
          <p class="text-xs text-emerald-400">Сибирский натуропат, Горный Алтай • 30+ лет практики</p>
        ...
        <div class="p-5 rounded-2xl border border-stone-800 bg-stone-900/80 space-y-2 flex flex-col justify-between">
          <div class="space-y-2">
            ...
            <ul class="text-xs text-stone-300 space-y-1.5 pt-2 border-t border-stone-800">
              ...
              <li>• Диафрагмальная гимнастика Ждана (3 минуты для снятия спазма сфинктера Одди)</li>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div class="p-4 rounded-2xl border border-stone-800 bg-stone-900/90 space-y-3 shadow-lg">
          ...
          <div class="p-3 bg-stone-950 rounded-xl text-xs text-stone-300 leading-relaxed border border-stone-800/80">
            «Ждан, доброе утро! Сегодня 6-й день. Я в шоке от языка: впервые за много лет он чистый, розовый, без белого налета! Живот плоский даже к вечеру, ушли утренние отеки. Минус 2.8 кг воды. Огромная благодарность за схему!»
          </div>
        ...
        <div class="p-4 rounded-2xl border border-stone-800 bg-stone-900/90 space-y-3 shadow-lg">
          ...
          <div class="p-3 bg-stone-950 rounded-xl text-xs text-stone-300 leading-relaxed border border-stone-800/80">
            «Как врач хочу отметить высокую физиологичность схемы Ждана. Никаких опасных тюбажей с маслом. Мягкие гидрохолеретики, теплая вода 40-45°C и дыхание — грамотная помощь печени.»
          </div>
          <div class="flex items-center gap-2 text-[11px] text-stone-400">
            <span>👍 52</span>
            <span>👏 44</span>
